...
abstract class StandardResponse implements Response {
    ...
    static class Status extends StandardResponse {
        @JsonProperty
        final com.thirdegg.chromecast.api.v2.Status status;

        Status(@JsonProperty("status") com.thirdegg.chromecast.api.v2.Status status) {
            this.status = status;
        }
    }
    ...
    static class MediaStatus extends StandardResponse {
        final com.thirdegg.chromecast.api.v2.MediaStatus[] statuses;

        MediaStatus(@JsonProperty("status") com.thirdegg.chromecast.api.v2.MediaStatus... statuses) {
    ...
    static class MultizoneStatus extends StandardResponse {
        @JsonProperty
        final com.thirdegg.chromecast.api.v2.MultizoneStatus status;

        MultizoneStatus(@JsonProperty("status") com.thirdegg.chromecast.api.v2.MultizoneStatus status) {
            this.status = status;
        }
    }
