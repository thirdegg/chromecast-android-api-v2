...
import com.thirdegg.chromecast.api.v2.CastChannel.CastMessage.PayloadType;
import com.thirdegg.chromecast.api.v2.CastChannel.DeviceAuthMessage;
...
import static com.thirdegg.chromecast.api.v2.Util.fromArray;
import static com.thirdegg.chromecast.api.v2.Util.toArray;
        ...
        void handle(CastMessage message) throws IOException {
            ...
            if (message.getPayloadType() == PayloadType.BINARY) {
                ...
                if (response != null) {
                    ...
                    logger.info("   destinationId: " + message.getSourceId());
                    logger.info("   namespace: " + message.getNamespace());
                    logger.info("   payloadType: " + PayloadType.STRING);
